...
colnames(raw_counts) <- plyr::mapvalues(colnames(raw_counts), 
                                    from = analysis$sampleTable$FileID,
                                    to = as.character(analysis$sampleTable$Label) )

# order counts as they are in the sampletable
raw_counts <- raw_counts[,as.character(analysis$sampleTable$Label)]
```
...
stopifnot(colnames(raw_counts) == as.character(analysis$sampleTable$Label))
