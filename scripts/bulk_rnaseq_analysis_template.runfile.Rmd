...
DESeq_results <- extractFilteredDESeqResults2(analysis$dds, my_contrasts[,1], max_min_samples = 1)
## Or apply to whole matrix
DESeq_results <- apply(my_contrast, 2, extractFilteredDESeqResults, dds = analysis$dds)
```
